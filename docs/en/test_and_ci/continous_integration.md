...
- **Basic Tests** - Unit tests, module configuration validation, module documentation checks
- **Clang-tidy** static analysis (16cpu runner)
- **EKF Change Detection** (PRs only)
...
**Runners:** Mixed (AWS 4cpu-linux-x64, 16cpu for clang-tidy, GitHub macos-latest)
